...
#     --video_source sucai \
#     --input_video_json /storage/hxy/ID/data/dataset_check/filter_jsons/sucai/istock_v4_chunk_25.json \
...
#     --video_source sucai \
#     --input_video_json /storage/hxy/ID/data/dataset_check/filter_jsons/sucai/istock_v4_chunk_26.json \
#     --output_json_folder /storage/hxy/ID/data/data_processor/track &
...
#     --video_source sucai \
#     --input_video_json /storage/hxy/ID/data/dataset_check/filter_jsons/sucai/istock_v4_chunk_27.json \
#     --output_json_folder /storage/hxy/ID/data/data_processor/track &
...
#     --video_source sucai \
#     --input_video_json /storage/hxy/ID/data/dataset_check/filter_jsons/sucai/istock_v4_chunk_28.json \
#     --output_json_folder /storage/hxy/ID/data/data_processor/track &


# CUDA_VISIBLE_DEVICES=4 python step1_get_bbox_kps.py --root /storage/dataset \
#     --video_source sucai \
#     --input_video_json /storage/hxy/ID/data/dataset_check/filter_jsons/sucai/istock_v4_chunk_29.json \
#     --output_json_folder /storage/hxy/ID/data/data_processor/track &
...
#     --video_source sucai \
#     --input_video_json /storage/hxy/ID/data/dataset_check/filter_jsons/sucai/istock_v4_chunk_30.json \
#     --output_json_folder /storage/hxy/ID/data/data_processor/track &
...
#     --video_source sucai \
#     --input_video_json /storage/hxy/ID/data/dataset_check/filter_jsons/sucai/istock_v4_chunk_31.json \
#     --output_json_folder /storage/hxy/ID/data/data_processor/track &
...
#     --video_source sucai \
#     --input_video_json /storage/hxy/ID/data/dataset_check/filter_jsons/sucai/istock_v4_chunk_32.json \
#     --output_json_folder /storage/hxy/ID/data/data_processor/track &
