...
* `[2024.12.09]`  🔥ConsisID will be merged into diffusers in the next version. So for now, please use `pip install git+https://github.com/SHYuanBest/ConsisID_diffusers.git` to install diffuser dev version.
